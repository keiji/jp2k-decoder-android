 ...
 * @property base64TransferTimeMs Time spent transferring/converting encoded string to JavaScript environment in milliseconds.
 * @property base64DecodeTimeMs Time spent decoding encoded string payload to Uint8Array inside JavaScript in milliseconds.
 * @property wasmProcessingTimeMs Time spent executing WebAssembly JPEG 2000 decoding function in milliseconds.
 * @property base64EncodeTimeMs Time spent encoding decoded raw bitmap buffer in JavaScript in milliseconds.
