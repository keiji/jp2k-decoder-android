 ...
 * wrapping the underlying asynchronous decoding logic.
 *
...
class Jp2kDecoder(
     ...
     *
     * This method prepares the JavaScript Sandbox and loads the WASM module.
     *
     ...
     *
     * @param j2kData The input JPEG2000 byte array.
     * @param colorFormat The desired output color format.
     * @return The decoded [Bitmap].
     * @throws IllegalArgumentException If the input data is too short.
     * @throws IllegalStateException If the decoder is not initialized or decoding fails.
     * @throws Jp2kException If the decoder reports an error.
     */
