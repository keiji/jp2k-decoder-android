...
class Jp2kDecoderSyntheticCoverageTest {
            ...
            if (method.name.contains("\$default")) {
                ...
                for (mask in 0..63) {
                    ...
                    for (i in params.indices) {
                        val p = params[i]
                        if (p == Jp2kDecoder::class.java) args[i] = decoder
                        ...
                        else if (p == kotlin.coroutines.Continuation::class.java) args[i] = mock(kotlin.coroutines.Continuation::class.java)
                    }
